...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " watcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  watcoin-tx [options] <hex-tx> [commands]  Update hex-encoded watcoin transaction\n" +
            "or:     watcoin-tx [options] -create [commands]   Create hex-encoded watcoin transaction\n" +
            "\n";
