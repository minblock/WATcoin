# Support for Output Descriptors in Watcoin Core

Since Watcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Watcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Watcoin Core wallets, a convenience function `combo` is
