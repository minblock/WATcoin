...
"""Verify that starting watcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start watcoin with -h for help text")
        ...
        self.log.info("Start watcoin with -version for version information")
        ...
        self.log.info("Start watcoind with -fakearg to make sure it does not start")
